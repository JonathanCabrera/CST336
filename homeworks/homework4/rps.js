...
function go() {
	...
	document.getElementById('lblRock').style.backgroundColor = '#EEEEEEE';
	document.getElementById('lblPaper').style.backgroundColor = '#EEEEEEE';
	document.getElementById('lblScissors').style.backgroundColor = '#EEEEEEE';
